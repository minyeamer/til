...
> ``` 1 3 3 ```<br>
> ``` 2 3 9999 ```<br>
> ``` graph = {1: {2: 1, 3: 3}, 2: {1: 1, 3: 2}, 3: {2: 2, 1: 3}} ```<br>
> ``` mst1 = [[1, 1, 0], [1, 2, 1], [2, 3, 2]], weight: 3 ```<br>
> ``` mst2 = [[2, 2, 0], [2, 1, 1], [2, 3, 2]], weight: 3 ```<br>
> ``` mst3 = [[3, 3, 0], [3, 2, 2], [2, 1, 1]], weight: 3 ```<br>
> ``` output: 3 ```<br>
> ``` answer: 3 ```<br><br>
> ``` 6 8 ```<br>
> ``` 1 3 -1 ```<br>
...
> ``` 3 5 -1 ```<br>
> ``` 5 6 -1 ```<br>
> ``` graph = {1: {3: -1, 5: 3, 6: 2}, 3: {1: -1, 4: 9, 5: -1}, 5: {1: 3, 2: 5, 3: -1, 6: -1}, 6: {1: 2, 2: 6, 5: -1}, 2: {5: 5, 6: 6}, 4: {3: 9}} ```<br>
> ``` mst1 = [[1, 1, 0], [1, 3, -1], [3, 5, -1], [5, 6, -1], [5, 2, 5], [3, 4, 9]], w = 11 ```<br>
> ``` mst2 = [[3, 3, 0], [3, 5, -1], [5, 6, -1], [3, 1, -1], [5, 2, 5], [3, 4, 9]], w =  11 ```<br>
> ``` mst3 = [[5, 5, 0], [5, 6, -1], [5, 3, -1], [3, 1, -1], [5, 2, 5], [3, 4, 9]] 11 ```<br>
> ``` mst4 = [[6, 6, 0], [6, 5, -1], [5, 3, -1], [3, 1, -1], [5, 2, 5], [3, 4, 9]] 11 ```<br>
> ``` mst5 = [[2, 2, 0], [2, 5, 5], [5, 6, -1], [5, 3, -1], [3, 1, -1], [3, 4, 9]] 11 ```<br>
> ``` mst6 = [[4, 4, 0], [4, 3, 9], [3, 5, -1], [5, 6, -1], [3, 1, -1], [5, 2, 5]] 11 ```<br>
> ``` output: 11 ```<br>
> ``` answer: -3 ```<br><br>
> ``` 3 3 ```<br>
> ``` 1 2 2 ```<br>
> ``` 1 3 3 ```<br>
> ``` 2 3 9999 ```<br>
> ``` graph = {1: {2: 2, 3: 3}, 2: {1: 2, 3: 9999}, 3: {1: 3, 2: 9999}} ```<br>
> ``` mst1 = [[1, 1, 0], [1, 2, 2], [1, 3, 3]], weight = 5 ```<br>
> ``` mst2 = [[2, 2, 0], [2, 1, 2], [1, 3, 3]], weight = 5 ```<br>
> ``` mst3 = [[3, 3, 0], [3, 1, 3], [1, 2, 2]], weight = 5 ```<br>
> ``` output: 5 ```<br>
> ``` answer: 3 ```<br>
**&nbsp;**
#### 결론:
